  ...
  return (
    <section id="portfolio-section" className="training-section">
      ...
      <PortfolioItem
        ...
        description="Este projeto foi desenvolvido para o site Movida Seminovos, com o objetivo de proporcionar uma experiência eficiente para os usuários na busca e seleção das lojas Movida. Minha atuação inclui criação e manutenção do site. 
      ...
      <PortfolioItem
        ...
        description="Este projeto consiste em uma landing page responsiva, desenvolvida para o cliente/parceiro (Amazon) em colaboração com a Movida Seminovos.  
                     ...
                     Este projeto destaca a minha habilidade de interpretar protótipos criados no Figma e transformar ideias em páginas dinâmicas e funcionais, atendendo às necessidades do cliente."
      />
      <PortfolioItem
        link="https://www.dafiti.com.br/"
        imgClassName="LP"
        title="Landing Page E-commerce"
        description="Projeto pessoal inspirado no e-commerce Dafiti e desenvolvido para exibir as principais logomarcas de forma destacada, em um carrossel com rolagem horizontal em loop que permite que usuário veja todas as marcas disponíveis com a funcionalidade de scroll ifinito com técnicas de CSS. 
